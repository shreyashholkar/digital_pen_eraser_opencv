...
st.title("             Virtual Pen and Eraser using openCV")

# Define CSS style for buttons
button_style = """
    <style>
        .stButton {
            background-color: #85C1E9; /* Green */
            color: black;
            padding: 15px 32px;
            text-align: center;
        ...
        .stButton:hover {
            background-color: #2874A6; /* Darker Green */
            color: white;
        }
    </style>
"""
...
if st.button("Find Colour Range", key="find_color_button"):
    find_colour_range()

if st.button("Noise Reduction", key="noise_reduction_button"):
    noise_reduction()

if st.button("Track Target Pen", key="track_pen_button"):
    track_target_pen()



if st.button("Virtual Pen and Eraser", key="virtual_pen_button"):
    virtual_pen()
